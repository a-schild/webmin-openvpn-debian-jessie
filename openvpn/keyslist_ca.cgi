...
print &ui_table_start($text{'newkey_title'}.": ".$in{'file_name'});
print &ui_table_row($text{'key_name'}, &ui_textbox('KEY_NAME','changeme',50),'',[ 'nowrap',1 ])."</tr>\n";
print "<tr>".&ui_table_row($text{'key_password'}, &ui_password('KEY_PASSWD','',50),'',[ 'nowrap',1 ])."</tr>\n";
print "<tr>".&ui_table_row('','<strong>'.$text{'warning_server_pass'}.'</strong>',[ 'align=right colspan=2 nowrap',1 ])."</tr>\n";
print "<tr>".&ui_table_row($text{'key_server'}, &ui_select('KEY_SERVER', 2, [ [2,$text{'client'}], [1,$text{'server'}] ]),'',[ 'nowrap',1 ])."</tr>\n";
print "<tr>".&ui_table_row($text{'key_pkcs12'}, &ui_select('KEY_PKCS12', 1, [ [1,$text{'no'}],[2,$text{'yes'}] ]),'',[ 'nowrap',1 ])."</tr>\n";
print "<tr>".&ui_table_row($text{'key_pkcs12_password'}, &ui_password('KEY_PKCS12_PASSWD','',50),'',[ 'nowrap',1 ])."</tr>\n";
print "<tr>".&ui_table_row($text{'key_expire'}, &ui_textbox('KEY_EXPIRE', $$info_ca{'CA_EXPIRE'},50),'',[ 'nowrap',1 ])."</tr>\n";
print "<tr>".&ui_table_row($text{'country'}, &ui_textbox('KEY_COUNTRY', $$info_ca{'KEY_COUNTRY'},50),'',[ 'nowrap',1 ])."</tr>\n";
print "<tr>".&ui_table_row($text{'province'}, &ui_textbox('KEY_PROVINCE', $$info_ca{'KEY_PROVINCE'},50),'',[ 'nowrap',1 ])."</tr>\n";
print "<tr>".&ui_table_row($text{'city'}, &ui_textbox('KEY_CITY', $$info_ca{'KEY_CITY'},50),'',[ 'nowrap',1 ])."</tr>\n";
print "<tr>".&ui_table_row($text{'org'}, &ui_textbox('KEY_ORG', $$info_ca{'KEY_ORG'},50),'',[ 'nowrap',1 ])."</tr>\n";
print "<tr>".&ui_table_row($text{'ou'}, &ui_textbox('KEY_OU', 'Office',50),'',[ 'nowrap',1 ])."\n";
print "<tr>".&ui_table_row($text{'email'}, &ui_textbox('KEY_EMAIL', $$info_ca{'KEY_EMAIL'},50),'',[ 'nowrap',1 ])."\n";
print &ui_table_end();
